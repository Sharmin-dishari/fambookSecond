    ...
    <q-footer class="backdrop-effect text-primary shadow-24 footer"
      ...
      <q-item class="flex-center">
        <q-item-section class="text-center text-white"><q-item-label
            class="text-center"><q-btn flat
              round
              icon="home"
              size="12px" />
            <q-item-label>Home</q-item-label></q-item-label></q-item-section>
        <q-item-section class="text-center text-white"><q-item-label
            class="text-center"><q-btn flat
              round
              icon="view_carousel"
              size="12px" />
            <q-item-label>My Post</q-item-label></q-item-label></q-item-section>
        ...
        <q-item-section class="text-center"><q-item-label
            class="text-center text-white"><q-btn flat
              ...
              icon="people"
              size="12px" />
            <q-item-label>Following</q-item-label></q-item-label></q-item-section>
        <q-item-section class="text-center"><q-item-label
            class="text-center text-white"><q-btn flat
              round
              icon="person_outline"
              size="12px" />
            <q-item-label>Profile</q-item-label></q-item-label></q-item-section>
      </q-item>
